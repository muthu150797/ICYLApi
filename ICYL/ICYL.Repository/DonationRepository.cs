...
namespace ICYL.Repository
{
    public class DonationRepository
    {
        ...
        public List<ICYL.BL.DonorSearchResult> getDonorSearchList(DonorSearch model)
        {
            List<ICYL.BL.DonorSearchResult> lst = new List<DonorSearchResult>();
            try
            {
        ...
        public List<ICYL.BL.DonationSearchResult> getPaymentSearchList(DonationSearch model)
        {
            List<ICYL.BL.DonationSearchResult> lst = new List<DonationSearchResult>();
            try
            {
        ...
        public ICYL.BL.PaymentConfig getDonorByConfigId(int PaymentConfigId)
        {
            ICYL.BL.PaymentConfig obj = new ICYL.BL.PaymentConfig();
            try
            {
        ...
        public ICYL.BL.PaymentConfigUserandPayment getDonorandPaymentByConfigId(int PaymentConfigId)
        {
            ICYL.BL.PaymentConfigUserandPayment obj = new ICYL.BL.PaymentConfigUserandPayment();
            try
            {
                DataTable dt = getDTDonorByConfigId(PaymentConfigId);
                obj.PaymentConfigId = Conversion.ConversionToInt(dt.Rows[0]["PaymentConfigId"]);
        ...
        public ICYL.BL.PaymentConfigUser getDonorUserByConfigId(int PaymentConfigId)
        {
            ICYL.BL.PaymentConfig obj = new BL.PaymentConfig();
            ICYL.BL.PaymentConfigUser model = new BL.PaymentConfigUser();
        ...
        public int AddPayments(ICYL.BL.PaymentConfig model,int source =1)
        {
        ...
        public int AddBatches(ICYL.BL.PaymentBatch model)
        {
