...
using static ICYL.API.Entity.GlobalContext;
...
namespace ICYL.API.Repository
{
    public class EmailRepository
    {
        ...
        public ReceiptBL Receipt(PaymentConfig model)
        {
        ...
        public byte[] DownloadDonationReceipt(int transactionId)
        {
            ...
            obj.Amount = "$" + model.AmtDonation.ToString();
            obj.TransactionDate = Convert.ToDateTime(model.TransactionDate);
        ...
        public EmailReceipt getEmailDetailsByTransactionId(int TransactionId)
        {
            //EmailReceipt obj = EmailReceipt();
