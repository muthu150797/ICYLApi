...
namespace ICYL.Repository
{
    ...
    {
        public List<LookupGroupBL> GetLookupGroup()
        {
        ...
        {
            List<SelectListItem> lCat = new List<SelectListItem>();
            List<LookupValueBL> lst = GetLookupValueByGroupId((int)GlobalContext.LookupGroupCategory.PaymentType);
            var list = new List<Object>();
            lCat = (from LookupValueBL row in lst
                    select new SelectListItem
                    {
        ...
        public List<BL.LookupValueBL> getLookupList(LookupValueBLList obj)
        {
            List<LookupValueBL> lst = new List<LookupValueBL>();
            try
            {
        ...
        public List<BL.LookupValueBL> getCategoryLookupList()
        {
            List<LookupValueBL> lst = new List<LookupValueBL>();
            try
            {
        ...
        public LookupValueBL GetLookupValueById(int Id)
        {
            LookupValueBL tc = new LookupValueBL();
            using (ICYLEntities dc = new ICYLEntities())
            {
        ...
        public DataTable getDataTableLookupList(LookupValueBLList obj)
        {
            try
            {
                string SQL = string.Empty;
        ...
        public LookupGroupBL GetLookupGroupById(int Id)
        {
            LookupGroupBL tc = new LookupGroupBL();
            using (ICYLEntities dc = new ICYLEntities())
            {
        ...
        public int SaveLookup(LookupValueBL model)
        {
            string SQL = string.Empty;
            object rValue = 0;
            IStoredProcedure sp = new StoredProcedure();
        ...
        public int UpdateLookup(LookupValueBL model)
        {
            string SQL = string.Empty;
            object rValue = 0;
            IStoredProcedure sp = new StoredProcedure();
