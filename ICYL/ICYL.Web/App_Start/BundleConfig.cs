...
namespace ICYL.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // inputmask config scriptC:\VSTS\ICYL\ICYL\ICYL\ICYL.Web\Scripts\inputmask\jquery.inputmask.min.js
            bundles.Add(new ScriptBundle("~/bundles/inputmask").Include(
                      "~/Scripts/inputmask/jquery.inputmask.min.js", "~/Scripts/inputmask/inputmask.min.js"));
